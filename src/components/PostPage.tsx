      ...
      if (mediaItem.mediaType === "IMAGE") {
        return (
          <img
            ...
            src={`http://localhost:8080/attachments/${mediaItem.mediaUrl}`}
            alt="Post Media"
    ...
    <div className="post-container">
      ...
      <ul className="post-list">
        {posts.map((post) => (
          <li key={post.postId.toString()} className="post-box">
            ...
            {media[post.postId.toString()] &&
              renderMedia(media[post.postId.toString()])}
            {post.updatedAt && (
      ...
      <div className="pagination-controls">
        <div>
          {posts.map((posts) => (
            <CommentsSection
              key={posts.postId} // Unique key for each comment
